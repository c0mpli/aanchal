...
import AllSlots from "./components/Dashboard/AllSlots";
  ...
  return (
    <>
            ...
            <div className="flex items-center">
              <div className="flex items-center ml-3">
                ...
                <div
                  className={`${
                    toggle && "hidden"
                  } z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600 absolute right-[3rem] top-[1rem]`}
                  id="dropdown-user"
                >
          ...
          <ul className="space-y-2 h-full">
            ...
            <li>
              <div
                ...
                className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <FaCrown className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
            ...
            <li>
              <div
                ...
                className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <FaHistory className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
            ...
            <li className="mt-auto">
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap text-red-500">
                  Logout
                </span>
              </div>
            </li>
      ...
      <div className="p-4 sm:ml-48">
        {page === 1 ? <AllSlots /> : page === 3 ? <Profile /> : page===4 ? <Premium /> : <Transaction />}
      </div>
    </>
  );
}
