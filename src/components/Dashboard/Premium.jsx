          ...
          <div className="relative z-10 -mx-4 group md:w-6/12 md:mx-0 lg:w-5/12">
            ...
            <div className="relative p-6 space-y-6 lg:p-8">
              ...
              >
                ...
                <li className="space-x-2">
                  <span className="text-purple-500 font-semibold">✓</span>
                  <span>Get featured on website</span>
                </li>
                <li className="space-x-2">
                  <span className="text-purple-500 font-semibold">✓</span>
                  <span>Get appointments from more cutomer</span>
                </li>
              </ul>
          ...
          <div className="relative group md:w-6/12 lg:w-7/12">
            ...
            <div className="relative p-6 pt-16 md:p-8 md:pl-12 md:rounded-r-2xl lg:pl-20 lg:p-16">
              ...
              <p className="text-gray-700">
                Get the most out of our platform with our premium plan. Enjoy
                advanced features and benefits, including priority customer
                support and appointment analytics.
              </p>
            </div>
          </div>
        </div>
